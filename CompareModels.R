...
###############################################################################################################
# ANÁLISE COM O USO DO FILTRO WAVELET - GERAL / SEGREGADO POR PRODUTO ----------------------------------------#
###############################################################################################################
Results_Wavelet <- IntegratedResults
Results_Wavelet <- Results_Wavelet[Results_Wavelet$Produto == "hydrous", ]
Results_Wavelet <- Results_Wavelet[Results_Wavelet$Produto == "anhydrous", ]
